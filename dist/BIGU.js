...
/***/ (function(module, exports, __webpack_require__) {
	...
	BIGU.GridRefParser.prototype.set_tetrad = function () {
	  this.tetradLetter = BIGU.GridRefParser.tetradLetters.substr((Math.floor(this.osRef.x % 10000 / 1000) >> 1) * 5 + (Math.floor(this.osRef.y % 10000 / 1000) >> 1), 1);
...
/***/ (function(module, exports) {
	...
	BIGU.GridRefParserGB.prototype.parse_gr_string_without_tetrads = function (gridRef) {
	  ...
	  switch (ref.length) {
	    case 2:
	      this.osRef = new BIGU.OSRef(x + ref.charAt(0) * 10000, // use first digit of ref
	    ...
	    case 4:
	      this.osRef = new BIGU.OSRef(x + Math.floor(ref / 100) * 1000, y + ref % 100 * 1000);
	      this.length = 1000; //1 km square
	      break;

	    case 6:
	      this.osRef = new BIGU.OSRef(x + Math.floor(ref / 1000) * 100, y + ref % 1000 * 100);
	      this.length = 100; //100m square
	      break;

	    case 8:
	      this.osRef = new BIGU.OSRef(x + Math.floor(ref / 10000) * 10, y + ref % 10000 * 10);
	      this.length = 10; //10m square
	      break;

	    case 10:
	      this.osRef = new BIGU.OSRef(x + Math.floor(ref / 100000), y + ref % 100000);
...
/***/ (function(module, exports) {
	 ...
	 * @constructor
	 */
	BIGU.GridRefParserIE = function () {};

	BIGU.GridRefParserIE.prototype = new BIGU.GridRefParser();
	BIGU.GridRefParserIE.prototype.constructor = BIGU.GridRefParserIE;
	BIGU.GridRefParserIE.prototype.country = 'IE';
	BIGU.GridRefParserIE.prototype.NationalRef = BIGU.OSIRef;

	BIGU.GridRefParserIE.gridLetter = {
	  A: [0, 4],
	  B: [1, 4],
	  C: [2, 4],
	  D: [3, 4],
	 ...
	 * @throws Error
	 */
	BIGU.GridRefParserIE.prototype.parse = function (rawGridRef) {
	  var trimmedLocality = rawGridRef.replace(/[\[\]\s\t\.-]+/g, '').toUpperCase();
	...
	BIGU.GridRefParserIE.prototype.parse_well_formed = BIGU.GridRefParserIE.prototype.parse;

	BIGU.GridRefParserIE._IE_GRID_LETTERS = 'VQLFAWRMGBXSNHCYTOJD';
	 ...
	 * @return boolean
	 */
	BIGU.GridRefParserIE.prototype.parse_gr_string_without_tetrads = function (gridRef) {
	  var x, y, ref, char;
	  ...
	  if (/^\d{2}\/(?:\d\d){1,5}$/.test(gridRef)) {
	    ...
	    char = BIGU.GridRefParserIE._IE_GRID_LETTERS.charAt(x * 5 + y);
	    ...
	    if (gridRef) {
	      ...
	      var p = BIGU.GridRefParserIE._IE_GRID_LETTERS.indexOf(char);
	  ...
	  switch (ref.length) {
	    case 2:
	      this.osRef = new BIGU.OSIRef(x + ref.charAt(0) * 10000, y + ref.charAt(1) * 10000);
	      this.length = 10000; //10 km square
	      this.hectad = char + ref;
	      break;

	    case 4:
	      this.osRef = new BIGU.OSIRef(x + Math.floor(ref / 100) * 1000, y + ref % 100 * 1000);
	      this.length = 1000; //1 km square
	      this.hectad = char + ref.charAt(0) + ref.charAt(2);
	      break;

	    case 6:
	      this.osRef = new BIGU.OSIRef(x + Math.floor(ref / 1000) * 100, y + ref % 1000 * 100);
	      this.length = 100; // 100m square
	      this.hectad = char + ref.charAt(0) + ref.charAt(3);
	      break;

	    case 8:
	      this.osRef = new BIGU.OSIRef(x + Math.floor(ref / 10000) * 10, y + ref % 10000 * 10);
	      this.length = 10; //10m square
	      this.hectad = char + ref.charAt(0) + ref.charAt(4);
	      break;

	    case 10:
	      this.osRef = new BIGU.OSIRef(x + Math.floor(ref / 100000), y + ref % 100000);
	      this.length = 1; //1m square
...
/***/ (function(module, exports) {
	...
	BIGU.IELatLng.prototype.IE_to_WGS84 = function () {
	  ...
	  var latLngRadians = BIGU.LatLng.transform(this.lat * deg2rad, this.lng * deg2rad, IRISH_AXIS, IRISH_ECCENTRIC, 0, WGS84_AXIS, WGS84_ECCENTRIC, 482.53, -130.596, 564.557, -1.042, -0.214, -0.631, -8.15);
...
/***/ (function(module, exports) {
	 ...
	 * @constructor
	 */
	BIGU.MappingUtils = function () {};

	//BIGU.MappingUtils.prototype = new BIGU.EventModelObject(); // inherit the BIGU event framework
	//BIGU.MappingUtils.prototype.constructor = BIGU.MappingUtils;
	 ...
	 * @type {string}
	 */
	BIGU.MappingUtils.tetradLetters = 'ABCDEFGHIJKLMNPQRSTUVWXYZ';
	 ...
	 * @type {string}
	 */
	BIGU.MappingUtils.tetradLettersRowFirst = 'AFKQVBGLRWCHMSXDINTYEJPUZ';

	BIGU.MappingUtils.irishGrid = {
	  0: ['V', 'Q', 'L', 'F', 'A'],
	  1: ['W', 'R', 'M', 'G', 'B'],
	  2: ['X', 'S', 'N', 'H', 'C'],
	  3: ['Y', 'T', 'O', 'J', 'D']
	 ...
	 */
	BIGU.MappingUtils.calculate_tetrad = function (easting, northing) {
	  return easting >= 0 && northing >= 0 ? BIGU.MappingUtils.tetradLetters.charAt(Math.floor(easting % 10000 / 2000) * 5 + Math.floor(northing % 10000 / 2000)) : '';
	};
	 ...
	 */
	BIGU.MappingUtils.irish_coords_to_hectad = function (easting, northing) {
	  ...
	  if (BIGU.MappingUtils.irishGrid[hundredkmE] && BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN]) {
	    return BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN] + Math.floor(easting % 100000 / 10000) + Math.floor(northing % 100000 / 10000);
	  } else {
	    return '';
	  }
	};
	 ...
	 */
	BIGU.MappingUtils.split_ie_coords = function (easting, northing) {
	  var hundredkmE = Math.floor(easting / 100000);
	  var hundredkmN = Math.floor(northing / 100000);
	  if (BIGU.MappingUtils.irishGrid[hundredkmE] && BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN]) {
	    return { letter: BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN], e: Math.floor(easting % 100000), n: Math.floor(northing % 100000) };
	  } else {
	    return null;
	  }
	};
	 ...
	 * @return {string} hectad
	 */
	BIGU.MappingUtils.gb_coords_to_hectad = function (easting, northing) {
	 ...
	 * @returns {string}
	 */
	//BIGU.MappingUtils._e_n_to_gr = function(letters, e, n, precision) {
	 ...
	 * @returns {{letter: string, e: number, n: number}}
	 */
	BIGU.MappingUtils.split_gb_coords = function (easting, northing) {
	  var hundredkmE = Math.floor(easting / 100000);
	  var hundredkmN = Math.floor(northing / 100000);
	  var firstLetter;
	  if (hundredkmN < 5) {
	 ...
	 * @returns {?string}
	 */
	BIGU.MappingUtils.ci_coords_to_hectad = function (easting, northing) {
	  if (northing > 5500000) {
	 ...
	 */
	BIGU.MappingUtils.ci_coords_to_grid_square = function (easting, northing, precision) {
	  if (northing > 5500000) {
	    return {
	      ...
	      gridref: BIGU.NationalGridCoords._e_n_to_gr('WA', easting - 500000, northing - 5500000, precision ? precision : 1)
	    };
	  } else if (northing < 5500000) {
	    return {
	      ...
	      gridref: BIGU.NationalGridCoords._e_n_to_gr('WV', easting - 500000, northing - 5400000, precision ? precision : 1)
	    };
	  }
	  return null;
	};
	 ...
	 * @returns {?{letter: string, e: number, n: number}}
	 */
	BIGU.MappingUtils.split_ci_coords = function (easting, northing) {
	  if (northing > 5500000) {
	 ...
	 * @returns {boolean}
	 */
	BIGU.MappingUtils.is_gb_hectad = function (hectad) {
	  return BIGU.MappingUtils.gbHectads.indexOf(hectad) !== -1;
	};

	BIGU.MappingUtils.gbHectads = '';
...
/***/ (function(module, exports) {
	...
	BIGU.NationalGridCoords._e_n_to_gr = function (letters, e, n, precision) {
	  ...
	  if (precision === 2000) {
	    return letters + eString.charAt(eString.length - 5) + nString.charAt(nString.length - 5) + BIGU.MappingUtils.calculate_tetrad(e, n);
	  } else if (precision === 100000) {
	    return letters;
	  } else {
	    if (precision === 5000) {
...
/***/ (function(module, exports) {
	...
	BIGU.OSIRef.prototype.to_gridref = function (precision) {
	  ...
	  if (BIGU.MappingUtils.irishGrid[hundredkmE] && BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN]) {
	    ...
	    return BIGU.NationalGridCoords._e_n_to_gr(BIGU.MappingUtils.irishGrid[hundredkmE][hundredkmN], this.x - 100000 * hundredkmE, this.y - 100000 * hundredkmN, precision ? precision : 1);
	  } else {
	    return null;
	  }
	};
...
/***/ (function(module, exports) {
	...
	BIGU.OSRef.prototype.to_gridref = function (precision) {
	  ...
	  return BIGU.NationalGridCoords._e_n_to_gr(firstLetter + secondLetter, this.x - 100000 * hundredkmE, this.y - 100000 * hundredkmN, precision ? precision : 1);
	};
...
/***/ (function(module, exports) {
	...
	BIGU.WGS84LatLng.prototype.to_IE_latlng = function () {
	  ...
	  var height = 0;
	  var latlng = BIGU.LatLng.transform(phip, lambdap, WGS84_AXIS, WGS84_ECCENTRIC, height, IRISH_AXIS, IRISH_ECCENTRIC, -482.53, 130.596, -564.557, 1.042, 0.214, 0.631, 8.15);
	...
	BIGU.WGS84LatLng.prototype.to_CI_latlng = function () {
	  ...
	  var height = 0;
	  var latlng = BIGU.LatLng.transform(phip, lambdap, WGS84_AXIS, WGS84_ECCENTRIC, height, CI_AXIS, CI_ECCENTRIC, 83.901, 98.127, 118.635, 0, 0, 0, 0);
